...
class VideoCallInfo extends StatefulWidget {
  @override
  _VideoCallInfoState createState() => _VideoCallInfoState();
}

class _VideoCallInfoState extends State<VideoCallInfo> {
              ...
              child: Row(
                ...
                children: <Widget>[
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text('Video', style: TextStyle(color: Color.fromRGBO(255, 208, 50, 1), fontSize: 40, fontWeight: FontWeight.bold),),
                      Text('Calling', style: TextStyle(color: Color.fromRGBO(255, 255, 255, 1), fontSize: 35, fontWeight: FontWeight.bold),), 
                      Padding(padding: EdgeInsets.symmetric(vertical: 1)),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
                          children: <Widget>[
                            Text('Bringing everyone closer through ', style: TextStyle(color: Colors.white70), ),
  ...
  Future<void> onJoin() async {
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => VideoCall(_channelNameController.text),
      ),
    );
